 ...
 * 
 * @export
 * @interface BlogPostPropertiesModel
 */
export interface BlogPostPropertiesModel {
    /**
     * 
     * @type {Date}
     * @memberof BlogPostPropertiesModel
     */
...
/**
 * Check if a given object implements the BlogPostPropertiesModel interface.
 */
export function instanceOfBlogPostPropertiesModel(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlogPostPropertiesModelFromJSON(json: any): BlogPostPropertiesModel {
    return BlogPostPropertiesModelFromJSONTyped(json, false);
}

export function BlogPostPropertiesModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogPostPropertiesModel {
...
export function BlogPostPropertiesModelToJSON(value?: BlogPostPropertiesModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
